  ...
  return (
    <Dialog open={open} onOpenChange={guardedOpenChange}>
      {/*
        ...
        ran the form to its end and then lurched the whole panel, header and
        all, through the remaining 10vh. Same defect and the same fix as the
        Add/Edit User modal in settings/manage-users, where the two scroll
        distances were measured in Chrome.
        ...
        The `max-h-[32vh] overflow-y-auto` list further down is NOT part of
        this defect — it is a bounded sub-region nested well below this body,
        not a second scroller stacked directly on the panel's own.
      */}
        ...
        <div className="space-y-3 flex-1 min-h-0 overflow-y-auto pr-1">
          ...
          */}
          ...
          {/*
            ...
            modal keeps its actions inside the same `flex-1 min-h-0 overflow-y-auto`
