 ...
 *
 * One page, SEVEN gliding tabs over the performance scorecards:
 *   Client · State · City · User · Employee · MTD · Technician (see TAB_ORDER for why this order)
 ...
 * When a user has none of the seven, we hand the first tab's body the job of
...
type PerfTab = 'client' | 'city' | 'technician' | 'state' | 'user' | 'employee' | 'mtd';
 ...
 *   Client → State → City → User → Employee → MTD → Technician
 ...
 * an attribution rule. It stays before Technician for the reason Employee
 * does: desk staff before field.
 */
const TAB_ORDER: PerfTab[] = ['client', 'state', 'city', 'user', 'employee', 'mtd', 'technician'];
...
export default function PerformanceReportPage() {
   ...
   * shown all seven to someone entitled to none.
   *
