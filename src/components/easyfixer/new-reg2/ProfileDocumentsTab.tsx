...
import { maskAadhaar, maskPan } from '@/lib/mask-identity';
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        >
          ...
          <KV k="Emergency mobile" v={maskMobile(p.emergency_mobile)} mono />
        ...
        <SectionCard title="Identity & documents" icon={<span>📄</span>}>
          <KV k="Aadhaar" v={maskAadhaar(id.adhaar_card_number)} mono />
          <KV k="PAN card" v={maskPan(id.pan_card_number)} mono />
