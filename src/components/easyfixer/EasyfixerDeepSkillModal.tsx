                ...
                <tr key={m.mapping_id} className="hover:bg-muted/40">
                  ...
                  <td className="!text-center">
                    <button
                      ...
                      className="inline-flex items-center justify-center size-7 rounded-full text-red-500 hover:bg-red-50 hover:text-red-600 disabled:opacity-40 disabled:cursor-not-allowed"
                    >
