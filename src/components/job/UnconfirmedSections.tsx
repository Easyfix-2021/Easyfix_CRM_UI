          ...
          return (
            ...
            >
              <header
                ...
                className="flex items-center gap-2 px-4 py-2 bg-surface-alt cursor-grab active:cursor-grabbing select-none"
                title="Drag to reorder this section"
              >
                <GripVertical className="w-4 h-4 text-ink-300" aria-hidden />
